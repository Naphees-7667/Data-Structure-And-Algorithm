...
🧠 Tips to Remember:
Use long when handling INT_MIN to avoid overflow.
Think of division as repeated subtraction, optimized via bit shifts.
a << b = a * 2^b
a >> b = a / 2^b (not used here but good to recall)
